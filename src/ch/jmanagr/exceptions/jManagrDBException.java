...
public class jManagrDBException extends jManagrException
{
	 ...
	 *                method.
	 */
	public jManagrDBException(String message)
	{
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public jManagrDBException(String message, Throwable cause)
	{
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public jManagrDBException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 * @since 1.7
	 */
	public jManagrDBException(String message, Throwable cause, boolean enableSuppression,
