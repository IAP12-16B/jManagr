...
public class jManagrException extends Exception
{
	 ...
	 *                method.
	 */
	public jManagrException(String message)
	{
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public jManagrException(String message, Throwable cause)
	{
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public jManagrException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 * @since 1.7
	 */
	public jManagrException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace)
	{
